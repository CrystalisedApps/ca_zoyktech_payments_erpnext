...
def get_payment_link_status(reference_id):
    ...
    try:
        ...
        return {
            ...
            "message": _("Payment link not found")
        }
...
def cancel_payment_link(reference_id):
    ...
    try:
        ...
        if payment_link.status == "Paid":
            return {
                "success": False,
                "message": _("Cannot cancel a paid payment link")
            }
        ...
        return {
            "success": True,
            "message": _("Payment link cancelled successfully")
        }
        ...
        return {
            "success": False,
            "error": str(e),
            "message": _("Failed to cancel payment link")
        }