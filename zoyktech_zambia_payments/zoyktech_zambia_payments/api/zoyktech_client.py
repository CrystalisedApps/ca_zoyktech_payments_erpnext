...
import time
from ..utils.helpers import validate_zambian_phone_number, format_zambian_phone_number
...
class ZoykTechClient:
    ...
    def get_settings(self):
        ...
        try:
            ...
            if not settings.zoyktech_api_key:
                frappe.throw(_("ZoykTech API Key is not configured in Payment Gateway Settings"))
            return settings
    ...
    def get_base_url(self):
        ...
        return self.settings.zoyktech_base_url or "https://api.zoyktech.com"
    
    def get_headers(self):
        """Get request headers with authentication"""
        return {
            'Content-Type': 'application/json',
            'Authorization': f'Bearer {self.settings.zoyktech_api_key}',
            'User-Agent': 'ZambiaPayments/1.0.0'
        }
